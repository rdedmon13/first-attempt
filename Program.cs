            ...
            while (menuChoice != 5)
            {
                switch (menuChoice)
                {
                    ...
                    case 3:
                        ...
                        else if (whatToChange == "Last Name")
                        {
                            Console.Write("What would you like Last Name to be? ");
                            var changeLastName = Console.ReadLine();
                            e.LastName = changeLastName;
                            Console.WriteLine("Last Name has been changed to {0}", changeLastName);
                        }

                        else if (whatToChange == "Department Name")
                        {
                            Console.Write("What would you like Department Name to be? ");
                            var changeDepartmentName = Console.ReadLine();
                            e.DepartmentName = changeDepartmentName;
                            Console.WriteLine("Department Name has been changed to {0}", changeDepartmentName);
                        }
